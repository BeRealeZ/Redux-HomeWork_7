...
const MainPage = () => {
    ...
    const text2 = "01.11.2023"
    const text3 = "Ivanov I.I"
    ...
    const y2 = (canvas.height - textWidth2) / 1.1    
    ...
    const x3 = (canvas.width - textWidth) - 610;
    const y3 = (canvas.height - textWidth3) / 1.115;
  ...
  return <button onClick={generatePdf}>открыть</button>;
};
